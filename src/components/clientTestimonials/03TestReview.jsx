        ...
        <div className="row">
          <div className="col-12">
            <div className="testimonial-heading text-center mb-5 heading-main">
              <span className="text-black uppercase">Words of Appreciation</span>
              <h2>
              Client Experiences <span>in their Own Words</span>
              </h2>
              <p>
              Team up with us today and the next review could be yours.
              </p>
            </div>
          </div>
        </div>
