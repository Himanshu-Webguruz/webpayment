        ...
        <div className="container">
          <div className="row">
            <div className="col-12 heading-main">
              <span className="dot">Here&apos;s What They Have to Say</span>
              <h2 className="mt-2">
                Our <span>Client Testimonials</span>
              </h2>
              <p>
                Our clients trust us more than our competitors and these
                statements stand testament to our claim.
              </p>
            </div>
          </div>
              ...
              <div className="video-content">
                ...
                <div className="video-review pt-md-5 pt-3 ps-md-4">
                  <p className="mb-0 mt-0">
                    &quot;The WebGuruz team has designed and developed our HS
                    website. We launched on time, according to the project plan.
                    All requests (like changes and fixes) have been answered and
                    implemented within two business days. Many thanks for the
                    great work!&quot;
                  </p>
                  <h3 className="pt-3 m-0 name">- Jakob Rieger</h3>
